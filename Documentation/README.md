...
├── Modeles/             # Notebook d'entraînement, configs YOLO, poids entraînés,
│                         # scripts et résultats du comparatif multi-modèles
├── Applications/        # Application Streamlit (dashboard) + dépendances
└── Documentation/        # README (ce fichier) et rapport écrit
```
...
Ouvrir `Modeles/projet.ipynb` et exécuter les cellules dans l'ordre (le dataset doit être
...
(voir `Documentation/Rapport.md`, section Livrables, pour la marche à suivre).
